...
public class CloseWalletTest {
    ...
    static final Logger logger = LoggerFactory.getLogger(CloseWallet.class); 
    ...
    @Test
    public void testCloseWallet() throws ClientException, ApiException {
        ...
        String s = "{\"host\":\"taiji.io\",\"service\":\"wallet\",\"action\":\"close\",\"version\":\"1.0.0\"}";
