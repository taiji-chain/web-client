...
/**
 * If you are holding some tokens, you can allow another address to withdraw tokens up the approved amount.
 *
 * @author Steve Hu
 */
@ServiceHandler(id="taiji.io/token/approve/1.0.0")
public class ApproveToken implements Handler {
